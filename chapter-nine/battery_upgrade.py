...
class Battery:
    """A simple attempt to model a car for an electric car"""
    ...
    def get_range(self):
        ...
        print(f"This car can go about {drive_range} miles on full charge")

    def upgrade_battery(self, new_capacity):
        """Check whether battery's size is equal o 65 or higher"""
...
e_car = ElectricCar("bmw", "i4", 2024)
e_car.battery.get_range()

e_car.battery.upgrade_battery(65)
e_car.battery.get_range()

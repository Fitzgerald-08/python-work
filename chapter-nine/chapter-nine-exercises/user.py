...
user1 = User("john", "fitzgerald", "south korea", "unknown")
user2 = User("random", "random", "germany", "mexico")
user3 = User("scott", "williams", "united states", "russia")

print(f"{user.describe_user().title()}")
user.greet_user()
print()
